...
* Wiring (монтаж;связывание)
  ...
  ```
    ...
    - В приложении существует только один экземлпяр типа Parrot
      ...
      parrot(), хотите сослаться на размещенный в контексте бин parrot Если для определения бина в контексте Spring была
      использована аннотация @Bean, то Spring отслеживает вызываемые методы и в конкретной ситуации может применить ту
      или иную логику
